...
edge_model = dict(
    ...
    data_preprocessor=dict(type='ActionDataPreprocessor', **edge_preprocess_cfg),
    train_cfg=None,
    test_cfg=None)
...
ann_file_test = '/root/autodl-tmp/dataset/K400/tiny-k400_train.txt'        # 'data/kinetics400/kinetics400_val_list_videos.txt'
...
train_pipeline = [
    ...
    # 报错`RuntimeError: Install pytorchvideo to use PytorchVideoTrans`
    # dict(
