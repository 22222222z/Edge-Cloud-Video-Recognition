...
class TSMEdgeModelHead(BaseHead):
    """Class head for TSM.
    ...
    def forward(self, x: list, num_segs: int = 8, **kwargs) -> Tensor:
        ...
        # print('cls_score.shape 1: {}'.format(cls_score.shape))  # 128 x 400 
        ...
        # print('cls_score.shape 2: {}'.format(cls_score.shape))  # 16 x 1 x 400
        # print('exit')
        # exit()
