...
class Recognizer3DCENet(BaseRecognizer):
    """3D recognizer model framework."""
    def __init__(self, backbone, cls_head = None, neck = None, train_cfg = None, test_cfg = None, data_preprocessor = None, \
                 edge_model=None, edge_feat_idx=None, edge_neck=None, edge_cls_head=None, distill_loss=None):
    ...
    def extract_feat(self,
        ...
        if test_mode:
            ...
            if self.test_cfg is not None and self.test_cfg.get(
                ...
                edge_output, edge_intermediate_feats = self.edge_model(inputs)
                delivered_edge_feat = edge_intermediate_feats[self.edge_feat_idx]
                delivered_edge_feat = self.edge_neck(delivered_edge_feat.clone())
            ...
            delivered_edge_feat = self.edge_neck(delivered_edge_feat.clone()) # [8, 32, 28, 28]
            ...
            self.edge_preds = self.edge_cls_head(edge_output).clone()
    ...
    def loss(self, inputs, data_samples, **kwargs):
        ...
        edge_cls_loss = self.edge_cls_head.loss(self.edge_output, data_samples)
